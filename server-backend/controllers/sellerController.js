...
const updateSellerProfile = async (req, res) => {
  try {
    ...
    const {
      storeName,companyName,gstNumber,phone,address,bio,expertise,password
    } = req.body || {};

    const updates = {storeName,companyName,gstNumber,phone,address,bio,expertise};
    ...
    res.status(200).json({ message: 'Seller profile updated', updatedSeller });
...
module.exports = {registerSeller,loginSeller,logoutSeller,deleteSellerByAdmin,
  getSellerProfile,
  updateSellerProfile,
  addProduct,
  updateProduct,
